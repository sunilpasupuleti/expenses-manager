...
import link_bank from '../../../assets/lottie/link_bank.json';
import bank_balance from '../../../assets/lottie/bank_balance.json';
import delete_json from '../../../assets/lottie/delete.json';
...
export const Loader = () => {
  ...
  useEffect(() => {
    if (isLoading) {
      ...
      if (loaderType === 'linkBank') {
        setAnimatedJson(link_bank);
      }

      if (loaderType === 'bankBalance') {
        setAnimatedJson(bank_balance);
      }
      if (loaderType === 'delete') {
        setAnimatedJson(delete_json);
      }
    } else {
      if (loaderType === 'spinner') {
